...
class Store(State):
    ...
    def create_button(self):
        ...
        #linha 1 coluna 1
        rmv_vel_max = Button(self, self.x_pos - 505 , self.y_pos - 250, 70, 70, "-", True, self.rmv_vel_max)
        add_vel_max = Button(self, self.x_pos - 200, self.y_pos - 250, 70, 70, "+", True, self.add_vel_max)
        self.all_sprites.add(rmv_vel_max)
        self.all_sprites.add(add_vel_max)
        ...
        #linha 1 coluna 2
        rmv_damage = Button(self, self.x_pos + 200, self.y_pos - 250, 70, 70, "-", True, self.rmv_damage)
        add_damage = Button(self, self.x_pos + 505, self.y_pos - 250, 70, 70, "+", True, self.add_damage)
        self.all_sprites.add(rmv_damage)
        self.all_sprites.add(add_damage)
        ...
        #linha 2 coluna 1
        rmv_life = Button(self, self.x_pos - 505, self.y_pos - 100, 70, 70, "-", True, self.rmv_life)
        add_life = Button(self, self.x_pos - 200, self.y_pos - 100, 70, 70, "+", True, self.add_life)
        self.all_sprites.add(rmv_life)
        self.all_sprites.add(add_life)
        ...
        # linha 2 coluna 2
        rmv_cooldown = Button(self, self.x_pos + 200, self.y_pos - 100, 70, 70, "-", True, self.rmv_cooldown)
        add_cooldown = Button(self, self.x_pos + 505, self.y_pos - 100, 70, 70, "+", True, self.add_cooldown)
        self.all_sprites.add(rmv_cooldown)
        self.all_sprites.add(add_cooldown)

        #linha 3
        rmv_qtd_bullet = Button(self, self.x_pos - 162, self.y_pos + 50, 70, 70, "-", True, self.rmv_qtd_bullet)
        add_qtd_bullet = Button(self, self.x_pos + 142, self.y_pos + 50, 70, 70, "+", True, self.add_qtd_bullet)
    ...
    def vel_max_rect(self):
        #1 rect
        self.rect(self.x_pos - 425, self.y_pos - 230, 50, 25, self.current_profile.ship_vel_max, 2)
        #2 rect
        self.rect(self.x_pos - 370, self.y_pos - 230, 50, 25, self.current_profile.ship_vel_max, 3)
        #3 rect
        self.rect(self.x_pos - 315, self.y_pos - 230, 50, 25, self.current_profile.ship_vel_max, 4)
        #4 rect
        self.rect(self.x_pos - 260, self.y_pos - 230, 50, 25, self.current_profile.ship_vel_max, 5)

    def damage_rect(self):
        #1 rect
        self.rect(self.x_pos + 280, self.y_pos - 230, 50, 25, self.current_profile.ship_damage, 2)
        #2 rect
        self.rect(self.x_pos + 335, self.y_pos - 230, 50, 25, self.current_profile.ship_damage, 3)
        #3 rect
        self.rect(self.x_pos + 390, self.y_pos - 230, 50, 25, self.current_profile.ship_damage, 4)
        #4 rect
        self.rect(self.x_pos + 445, self.y_pos - 230, 50, 25, self.current_profile.ship_damage, 5)

    def life_rect(self):
        #1 rect
        self.rect(self.x_pos - 425, self.y_pos - 80, 50, 25, self.current_profile.ship_life, 2)
        #2 rect
        self.rect(self.x_pos - 370, self.y_pos - 80, 50, 25, self.current_profile.ship_life, 3)
        #3 rect
        self.rect(self.x_pos - 315, self.y_pos - 80, 50, 25, self.current_profile.ship_life, 4)
        #4 rect
        self.rect(self.x_pos - 260, self.y_pos - 80, 50, 25, self.current_profile.ship_life, 5)

    def cooldown_rect(self):
        # 1 rect
        self.rect(self.x_pos + 280, self.y_pos - 80, 50, 25, self.current_profile.ship_cooldown, 2)
        # 2 rect
        self.rect(self.x_pos + 335, self.y_pos - 80, 50, 25, self.current_profile.ship_cooldown, 3)
        # 3 rect
        self.rect(self.x_pos + 390, self.y_pos - 80, 50, 25, self.current_profile.ship_cooldown, 4)
        # 4 rect
        self.rect(self.x_pos + 445, self.y_pos - 80, 50, 25, self.current_profile.ship_cooldown, 5)

    def qtd_bullet_rect(self):
        # 1 rect
        self.rect(self.x_pos - 82, self.y_pos + 70, 50, 25, self.current_profile.ship_qtd_bullet, 2)
        # 2 rect
        self.rect(self.x_pos - 27, self.y_pos + 70, 50, 25, self.current_profile.ship_qtd_bullet, 3)
        # 3 rect
        self.rect(self.x_pos + 27, self.y_pos + 70, 50, 25, self.current_profile.ship_qtd_bullet, 4)
        # 4 rect
        self.rect(self.x_pos + 82, self.y_pos + 70, 50, 25, self.current_profile.ship_qtd_bullet, 5)
